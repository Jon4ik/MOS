...
links=(
    ...
    "https://git.altlinux.org/tasks/296706/build/300/x86_64/rpms/libcrypto10-1.0.2u-alt1.p9.2.x86_64.rpm"
    "https://git.altlinux.org/tasks/296706/build/300/x86_64/rpms/libssl10-1.0.2u-alt1.p9.2.x86_64.rpm"
...
rpms=(
    "libcrypto10-1.0.2u-alt1.p9.2.x86_64.rpm"
    "libssl10-1.0.2u-alt1.p9.2.x86_64.rpm"
    "libicu60-6.0.2-alt1.x86_64.rpm"
)

yes | apt-get install libjpeg8 > /dev/null &&
for rpm in ${rpms[*]}; do
    rpm -i $rpm > /dev/null
done &&
